...
<template>
  <div class="min-h-screen bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white transition-colors duration-300">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <!-- 项目基本信息 -->
      <div v-if="loading" class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
        <div class="p-6">
      ...
      <div v-else-if="project" class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
        <div class="p-6">
    ...
    <!-- 添加任务对话框 -->
    <n-modal v-model:show="showAddTaskDialog" preset="card" title="添加任务" :content-style="{maxWidth: '500px'}">
      <div class="space-y-4">
        <div>
