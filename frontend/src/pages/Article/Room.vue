...
const roomArticle = ref<any>({
  title: '从南山到南山：众创空间的旅途',
  date: '',
  watch: 0,
  content: historyRoomContent,
})
...
watch(
    ...
    (newId) => {
      if (newId === 'History-Room') {
        ...
        document.title = '从南山到南山：众创空间的旅途 - 西建大 iOS Club'
      } else {
        roomArticle.value = {
          title: '文章未找到',
          date: '',
        ...
        document.title = '文章未找到 - 西建大 iOS Club'
      }
    },
    { immediate: true }
)
