...
public interface IDataAccessStatisticsService
{
    ...
    Task RecordDataAccessAsync(string entityType, string dataId, string operationType, CancellationToken cancellationToken = default);
    ...
    Task<DataAccessStatisticsResult> GetDataAccessStatisticsAsync(string? entityType = null, int top = 10, CancellationToken cancellationToken = default);
    ...
    Task<DataChangeStatisticsResult> GetDataChangeStatisticsAsync(string? entityType = null, int top = 10, CancellationToken cancellationToken = default);
...
public class DataAccessStatisticsService(IDistributedCache distributedCache) : IDataAccessStatisticsService
{
    ...
    public async Task RecordDataAccessAsync(string entityType, string dataId, string operationType, CancellationToken cancellationToken = default)
    {
        // 标准化实体类型名称
    ...
    public async Task<DataAccessStatisticsResult> GetDataAccessStatisticsAsync(string? entityType = null, int top = 10, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<DataChangeStatisticsResult> GetDataChangeStatisticsAsync(string? entityType = null, int top = 10, CancellationToken cancellationToken = default)
    {
